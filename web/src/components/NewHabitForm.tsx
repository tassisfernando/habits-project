...
export function NewHabitForm() {
  ...
  function handleToggleWeekDay(weekDay: number) {
    if (weekDays.includes(weekDay)) {
      ...
      const weekDaysWithAddedOne = [...weekDays, weekDay].sort();
    ...
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      <button
        ...
        className="mt-6 rounded-lg p-4 flex items-center justify-center gap-3 font-semibold bg-green-600 
          hover:bg-green-500 transition-colors focus:outline-none focus:ring-2 focus:ring-green-700 focus:ring-offset-2 focus:ring-offset-zinc-900"
      >
